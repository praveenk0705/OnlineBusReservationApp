...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <html:form action="ticket_cancel.do">
      <table width="583" height="123" border="1" cellpadding="5" cellspacing="2">
      <caption>&nbsp;
      </caption>
        <tr>
            <td width="105" height="33" align="center" class="style9">Seat No</td>
            <td width="163"><html:text property="seatno"/></td>

            <td width="108" align="center"><span class="style9">Bus No</span></td>
            <td width="181"><html:text property="busno"/></td>
	</tr>
      <tr>
        <td height="48" align="center"><span class="style9">Journey Date</span></td>
        <td colspan="3">
      ...
      <tr>
          <td height="30" colspan="2" align="center"><html:submit property="action" value="Cancel Ticket"/></td>
