...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <html:form action="bus_info.do">
      <table width="617" height="132" border="1" cellpadding="5" cellspacing="2">
      <caption>&nbsp;
      </caption>
        <tr>
        <td width="96" height="42" align="center" class="style5">From Stop</td>
      <td width="121">
      <html:select property="stopone">
	    ...
	    <td width="102" align="center"><span class="style5">To Stop</span></td>
     <td width="149">
