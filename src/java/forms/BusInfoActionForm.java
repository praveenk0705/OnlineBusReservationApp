 ...
 * @author dl723
 */
public class BusInfoActionForm extends org.apache.struts.action.ActionForm {
    ...
    {
         System.out.println("setservice "+servicetype);
        return servicetype;
    }

    
    public void setServicetype(String servicetype) {
        System.out.println("getsrv "+servicetype );
