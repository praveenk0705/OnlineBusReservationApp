...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <html:form action="bus_info.do">
      <table width="583" height="123" border="1" cellpadding="5" cellspacing="2">
      <caption>&nbsp;
      </caption>
        <tr>
        <td width="105" height="33" align="center" class="style5">From Stop</td>
      <td width="163">
  <html:select property="stopone">
	    ...
	    <td width="108" align="center"><span class="style5">To Stop</span></td>
     <td width="181">
...
<html:select  property="stoptwo">
      ...
      <tr>
        ...
        <td height="48" align="center"><span class="style5">Journey Date</span></td>
        <td>
            <script type="text/javascript" src="Datetimepicker/datetimepicker_css.js"></script>
            <input id=demo1 maxLength=20 size=20/> <img style="CURSOR:pointer" onclick="javascript:NewCssCal('demo1')" alt="" src="images/cal.gif"/>
        </td>

        <td align="center"><span class="style5">Bus Service </span></td>
<td><span class="style5"> <html:select property="servicetype"></span>
                    <html:option key="select" value="Select Choice..."></html:option>
                    <html:option key="A/C" value="A/C"></html:option>
                    <html:option key="Semi-Luxury" value="Semi-Luxury"></html:option>
             </html:select></td>
      </tr>
